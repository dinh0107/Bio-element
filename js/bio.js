...
(function () {
    ...
    function initMobileNav() {
        ...
        function closeMenu() {
            ...
            $('.site-header__nav-inner > li.active')
                .removeClass('active')
                .children('.site-header__submenu')
                .hide();
        }

        function closeOtherSubmenus(currentItem) {

            panel.querySelectorAll('.is-submenu-open').forEach(function (item) {
        ...
        $(document).on('click', '.site-header__nav-caret', function (e) {
    ...
    function initStickyHeader() {
        ...
        var scrollIcon = document.querySelector('.box-icon-scroll');
        ...
        function onScroll() {
            var isScrolled = window.scrollY >= stickyOffset;

            header.classList.toggle('is-scrolled', isScrolled);

            if (scrollIcon) {
                scrollIcon.classList.toggle('active', isScrolled);
            }
        }
    ...
    function initTherapyTabs() {
        ...
        function changeImage(src, callback) {
        ...
        function activateTab(tab) {
            ...
            if (tab.dataset.image) {
                preloadImage(tab.dataset.image, function () {
                    changeImage(tab.dataset.image);
                });
            }
        }
        ...
        tabs.forEach(function (tab) {
            ...
            if (tab.dataset.image) {
                preloadImage(tab.dataset.image);
            }
...
(function ($) {
    ...
    function initAchievementSlider() {
        ...
        if ($track.hasClass('owl-loaded')) {
            $track.trigger('destroy.owl.carousel');
            $track.find('.owl-stage-outer').children().unwrap();
            $track.removeClass('owl-center owl-loaded owl-text-select-on');
        }
    ...
    function initPress() {
        var $section = $('.the-press');
        var $track = $section.find('.the-press-slide');
        var $dots = $section.find('.press__dots');
